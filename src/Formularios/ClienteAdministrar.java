   ...
   */
   ...
   public void MostrarTelefonos(){
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 58, 528, 380));
        ...
        jPanelEmail.add(jButtonEmailEditar, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 11, 70, 20));
        ...
        jPanelEmail.add(jButtonEmailCancelar, new org.netbeans.lib.awtextra.AbsoluteConstraints(86, 11, 93, 20));
        ...
        jPanelEmail.add(jButtonEmailAgregar, new org.netbeans.lib.awtextra.AbsoluteConstraints(259, 11, 80, 20));

        jLabel7.setText("Email");
        jPanelEmail.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 37, -1, -1));
        jPanelEmail.add(jTextFieldEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 57, 329, -1));
        ...
        jPanelEmail.add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 88, 329, 285));
        ...
        jPanelDireccion.add(jButtonDireccionAgregar, new org.netbeans.lib.awtextra.AbsoluteConstraints(259, 11, 80, 20));
        ...
        jPanelDireccion.add(jButtonDireccionCancelar, new org.netbeans.lib.awtextra.AbsoluteConstraints(92, 11, 92, 20));
        ...
        jPanelDireccion.add(jButtonDireccionEditar, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 11, 76, 20));

        jLabel8.setText("Dirección");
        jPanelDireccion.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 49, -1, -1));
        ...
        jPanelDireccion.add(jScrollPane4, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 171, 329, 202));

        jTextAreaDireccion.setColumns(20);
        jTextAreaDireccion.setRows(5);
        jScrollPane6.setViewportView(jTextAreaDireccion);

        jPanelDireccion.add(jScrollPane6, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 69, 329, -1));

        jTabbedPane1.addTab("Dirección", jPanelDireccion);

        jPanelTelefono.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel5.setText("Tipo de teléfono");
        jPanelTelefono.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(11, 50, 90, -1));
        jPanelTelefono.add(jTextFieldTelefono, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 120, 320, -1));

        jPanelTelefono.add(jComboBoxTipoTelefono, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 70, 320, -1));

        jLabel6.setText("Teléfono");
        jPanelTelefono.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(11, 100, 90, -1));
        ...
        jPanelTelefono.add(jButtonTelefonoAgregar, new org.netbeans.lib.awtextra.AbsoluteConstraints(251, 10, 80, 20));
        ...
        jPanelTelefono.add(jButtonTelefonoCancelar, new org.netbeans.lib.awtextra.AbsoluteConstraints(94, 10, 90, 20));
        ...
        jPanelTelefono.add(jButtonTelefonoEditar, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 78, 20));
        ...
        jPanelTelefono.add(jScrollPane5, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 146, 320, 216));
        ...
        jPanelTelefono.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 50, -1, -1));

        jTabbedPane1.addTab("Teléfonos", jPanelTelefono);

        getContentPane().add(jTabbedPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 39, 354, -1));
        ...
        getContentPane().add(jButtonAgregarCliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 10, 80, -1));
        ...
        getContentPane().add(jButtonCancelarCliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 10, 97, -1));
        ...
        getContentPane().add(jButtonEditarCliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 80, -1));
        ...
        getContentPane().add(jTextFieldBuscador, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 30, 520, -1));

        jLabel9.setText("Que deseas buscar?");
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 10, -1, -1));
