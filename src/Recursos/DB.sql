...
alter table `persona_direccion` add(persona_id int);
alter table `persona_email` add(persona_id int);
alter table `persona_telefono` add(persona_id int);
alter table `proveedor` add(visible boolean default true);
alter table `proveedor` add (rnc varchar(30)); 
alter table `producto` add(visible boolean default true);
alter table `compra_producto` add(visible boolean default true);
